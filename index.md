...
- [Lời mở đầu](#introduction)
	...
	- [Điều kiện tiên quyết](#what-is-required-to-do-this)
	- [Đối tượng của bài viết này là ai?](#who-is-this-for)
	- [Tôi nên học toán như thế nào?](#how-to-study-mathematics)
- [Phần I: Các môn cơ bản](#part-i-core-subjects)
	- [Tìm hiểu những khái niệm cơ bản](#discovering-the-basics)
		- [Về học và siêu nhận thức](#learning-and-metacognition)
		- [Toán phổ thông (tiền giải tích)](#precalculus)
		- [Vi tích phân](#calculus)
		- [Các cách chứng minh](#proof-techniques)
	- [Xây dựng một nền tảng vững chắc](#building-foundations)
		- [Đại số tuyến tính](#linear-algebra)
		- [Giải tích thực](#real-analysis)
		- [Toán rời rạc](#discrete-mathematics)
		- [Lý thuyết số cơ bản](#basic-number-theory)
	- [Nắm chắc cơ bản](#mastering-the-fundamentals)
		- [Đại số trừu tượng](#abstract-algebra)
		- [Tô pô đại cương](#general-topology)
		- [Phương trình vi phân thường](#ordinary-differential-equations)
		- [Hình học vi phân cổ điển](#classical-differential-geometry)
- [Phần II: Các môn tự chọn](#part-ii-electives)
	- [Giải tích](#analysis)
	- [Đại số](#algebra)
	- [Tô pô](#topology)
	...
	- [Ứng dụng](#applications)
		...
		- [Sinh học](#biology)
		- [Hóa học](#chemistry)
- [Các định hướng](#part-iii-possible-tracks)
	- [Track Generalist](#generalist-track)
	- [Track Giải tích](#analyst-track)
	- [Track Đại số](#algebraist-track)
	- [Track Hình học](#geometer-track)
	- [Track Hình học đại số](#algebraic-geometer-track)
	- [Track Lý thuyết số](#number-theorist-track)
	- [Track Toán vật lý](#physicist-track)
	- [Track Khoa học máy tính](#computer-scientist-track)
	- [Track Toán tài chính](#finance-track)
